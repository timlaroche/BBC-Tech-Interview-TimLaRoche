...
var _typeof110 = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
	...
	_createClass(App, [{
		...
		value: function render() {
			...
			if (this.state.reading === false) {
				return _react2.default.createElement(_react2.default.Fragment, null, _react2.default.createElement(_semanticUiReact.Container, { text: true }, _react2.default.createElement(_semanticUiReact.Header, { as: 'h2', style: { display: "block", margin: "0 auto", "text-align": "center", "padding": '3em' } }, _react2.default.createElement('img', { src: 'bbclogo.svg', alt: 'BBC' }), ' Article Ranker'), _react2.default.createElement('p', null, ' Welcome to the BBC Article Ranker. '), _react2.default.createElement('p', null, 'Please take your time to read the 5 articles you are presented and rank them at the end. '), _react2.default.createElement(_semanticUiReact.Button, { onClick: function onClick(e) {
			...
			if (this.state.currentIndex > 5) {
				...
				return _react2.default.createElement(_react2.default.Fragment, null, _react2.default.createElement(_semanticUiReact.Grid, { verticalAlign: 'middle', style: { "padding": '3em' }, centered: true }, _react2.default.createElement(_semanticUiReact.Grid.Row, null, _react2.default.createElement(_semanticUiReact.Grid.Column, { width: 16 }, _react2.default.createElement(_semanticUiReact.Header, { as: 'h2', style: { display: "block", margin: "0 auto", "text-align": "center" } }, _react2.default.createElement('img', { src: 'bbclogo.svg', alt: 'BBC' }), ' Article Ranker'))), _react2.default.createElement(_semanticUiReact.Grid.Row, null, _react2.default.createElement(_semanticUiReact.Grid.Column, { width: 4 }, _react2.default.createElement(_semanticUiReact.Icon, { name: 'chevron left' })), _react2.default.createElement(_semanticUiReact.Grid.Column, { width: 8 }, _react2.default.createElement(_content2.default, { articleURL: "http://localhost:3000/article-" + this.state.currentIndex }), _react2.default.createElement(_semanticUiReact.Button, { onClick: function onClick(e) {
						return _this2.nextArticle(e);
					} }, ' Next Article '), this.state.showPrev != 0 && _react2.default.createElement('button', null, ' Previous Article ')), _react2.default.createElement(_semanticUiReact.Grid.Column, { width: 4 }, _react2.default.createElement(_semanticUiReact.Icon, { name: 'chevron right' })))));
			}
		}
	}, {
		key: 'nextArticle',
